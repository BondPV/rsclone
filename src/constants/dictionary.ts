...
export const Dictionary: DictionaryLang = {
  ...
  DE: {
    ...
    accountExpense: 'Konto',
    commentExpense: 'Kommentar',
    paginationLimit: 'Auf der Seite anzeigen:',
    emptyExpenseList: 'Es gibt noch keine Ausgaben in Ihrer Tabelle.',
